...
public class DiskSearcher {
	...
	private static final String USAGE = "Usage: java DiskSearcher "
			+ "<extension> <root directory> <destination directory>" 
	 ...
	 * given command lines:
	 * @param extension - The file extension to be searched. 
	 * @param root - The directory to start searching from. 
	 * @param destination - The directory to copy all files to.
	 * @param searchThreads - Number of Search threads to use. 
	 * @param copierThreads - Number of Copier threads to use. 
	 */
