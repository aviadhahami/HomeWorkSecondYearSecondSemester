namespace B15_Ex01_3
{
    ...
    public class Program
    {
        ...
        private static void printLineOfClockUp(int i_LineNum)
        {
            ...
            {
                // $G$ NTT-006 (-10) You should have used StringBuilder to build the string and print it once at the end. 
        ...
        // $G$ DSN-004 (-3) Code duplication, you could use one method with different parameters for the loop.
