...
namespace B15_EX3_AVIADHAHAMI_ID_OMERWINTER_ID
{
    ...
    {
        public ElectricMotorcycle(string i_Model, string i_LicenseNumber, float i_RemainingEnergy, List<Tier> i_tiers, string i_tierManufacturer, bool i_electricCar)
