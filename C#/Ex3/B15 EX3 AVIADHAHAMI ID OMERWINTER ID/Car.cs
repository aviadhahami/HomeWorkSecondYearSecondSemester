...
namespace B15_EX3_AVIADHAHAMI_ID_OMERWINTER_ID
{
    class Car : Vehicle
    {
        ...
        int m_numberOfDors;
        Colors m_color;
        public Car(int i_NumberOfDors, Colors i_Color, List<float> i_PressurInTiers, VehicleInfo i_ElectricVehicle, string i_Model, string i_LicenseNumber, float i_RemainingEnergy, string i_TierManufacturer)
            : base(i_Model, i_LicenseNumber, i_RemainingEnergy,i_TierManufacturer)
        {
            ...
            if (i_ElectricVehicle == VehicleInfo.ElectricCar)
            {
